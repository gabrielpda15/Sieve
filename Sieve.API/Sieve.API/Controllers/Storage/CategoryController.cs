...
namespace Sieve.API.Controllers.Storage
{
    ...
    [Route("[controller]")]
    [SieveAuth]
    public class CategoryController : CrudController<CategoryRepository, Category>
    {
        public CategoryController(IUnitOfWork unitOfWork, IUserContext userContext) : base(unitOfWork, userContext)
        {
        }
    }
}
