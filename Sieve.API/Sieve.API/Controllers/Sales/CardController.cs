...
namespace Sieve.API.Controllers.Sales
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class CardController : CrudController<CardRepository, Card>
    {
        public CardController(IUnitOfWork unitOfWork, IUserContext userContext) : base(unitOfWork, userContext)
        {
        }
    }
}
