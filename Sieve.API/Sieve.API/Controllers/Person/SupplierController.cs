...
namespace Sieve.API.Controllers.Person
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class SupplierController : CrudController<SupplierRepository, Supplier>
    {
        public SupplierController(IUnitOfWork unitOfWork, IUserContext userContext) : base(unitOfWork, userContext)
        {
        }
    }
}
